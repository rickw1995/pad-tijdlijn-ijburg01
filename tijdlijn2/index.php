...
<form accept-charset="utf-8" class="form-nieuws col s12" id="Form1" method="post" name="Form1" style="display: none;">
        ...
        <div class="row">
            <div class="input-field col s12">
                <label for="naam">Titel van de tijdlijn:</label> <input class="validate <?= $titel ?> form-control" id="titel" name="titel" type="text" value="<?= isset($_POST['titel']) ? $_POST['titel'] : '' ?>"><br>
            </div>
        </div>
        <div class="row">
            <div class="input-field col s12">
                <label for="naam">Beschrijving:</label> 
                <textarea class="materialize-textarea <?= $beschrijving ?> form-control" id="beschrijving" name="beschrijving"></textarea>
            </div>
        </div>
        <div class="row">
            <div class="input-field col s12">
